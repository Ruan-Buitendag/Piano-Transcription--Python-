...
if __name__ == "__main__":
    ...
    # path_root_maps = "C:\\Users\\ruanb\\OneDrive\\Desktop\\Piano Transcription\\Piano Transcription\\MAPS"
    path_root_maps = "../MAPS"
    ...
    try:
        ...
        raise NotImplementedError(
            "The piano type (1st or 2nd argument) should be a MAPS piano name, instead got: {}".format(sys.argv[1],
                                                                                                       sys.argv[2]))
    ...
    persisted_path = "../data_persisted/CQT"
        ...
        for T in [5, 10, 20]:
            ...
            for a_song in list_files_wav:
                ...
                H_to_persist_name = "activations_song_{}_W_learned_{}_beta_{}_T_{}_init_{}_stftAD_{}_itmax_{}_intensity_W_{}_time_limit_{}_tol_{}".format(
                    song_name, piano_W, beta, T, init, model_AD, itmax_H, note_intensity, time_limit, tol)
